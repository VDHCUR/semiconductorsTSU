    ...
    <main class="container pl-md-0 mb-3">
        <div class="row">
            <div class="col-md-3 sidebar d-none d-md-block">
                <div class="btn btn-light w-100 rounded-0 mb-2 active shadow-sm">Бакалавриат</div>
                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb">
                            <h6 class="breadcrumb-item"><a href="/">Главная</a> > <a href="/student">Студенту</a> >
                                <span
                                        class="text-muted">Бакалавриат</span></h6>
                        </nav>
                    </div>
                </div>
                <div class="row pt-2 pb-1">
                    <div class="col text-center">
                        <h4 class="font-weight-bold">Бакалавриат</h4>
                    </div>
                </div>
                @if(empty($profiles[0]))
